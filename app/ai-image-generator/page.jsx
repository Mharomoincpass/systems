    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pt-24 pb-16">
        ...
        <section className="mt-10 flex flex-col sm:flex-row gap-3">
          <Link href="/dashboard/images" className="px-5 py-2 rounded-lg bg-white text-black text-sm font-semibold hover:scale-105 hover:shadow-xl hover:shadow-white/20 transition-all duration-300 ease-out">
            Try the tool
          </Link>
