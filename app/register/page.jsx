...
export default function RegisterPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-black overflow-hidden">
      ...
      <div className="absolute top-1/4 -right-32 w-64 sm:w-96 h-64 sm:h-96 bg-white/5 rounded-full blur-[128px]" />
      <div className="absolute bottom-1/4 -left-32 w-64 sm:w-96 h-64 sm:h-96 bg-white/5 rounded-full blur-[128px]" />
      ...
      <div className="relative z-10 w-full max-w-sm sm:max-w-md px-4 sm:px-6">
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-400 text-xs sm:text-sm transition-all duration-300">
            ...
            <Link href="/login" className="text-white hover:text-gray-200 font-semibold transition-colors duration-300">
              Sign in
            </Link>
          </p>
        </div>
