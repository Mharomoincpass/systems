    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pt-24 pb-16">
        ...
        <section className="mt-10 flex flex-col sm:flex-row gap-3">
          <Link href="/api/tools/launch?path=/tts" className="px-5 py-2 rounded-lg bg-white text-black text-sm font-semibold">
            Try the tool
          </Link>
          <Link href="/blogs" className="px-5 py-2 rounded-lg border border-white/20 text-sm font-semibold">
            Read the blog
          </Link>
          <Link href="/systems/documentation/tts" className="px-5 py-2 rounded-lg border border-white/20 text-sm font-semibold">
            View documentation
          </Link>
        </section>
      </div>
