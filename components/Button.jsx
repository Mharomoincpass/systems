...
export function Button({
  ...
  const variantStyles = {
    primary: 'bg-primary-600 text-foreground hover:bg-primary-700 focus:ring-primary-500',
    secondary: 'bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-foreground hover:bg-gray-300 dark:hover:bg-gray-600 focus:ring-gray-500',
  }
